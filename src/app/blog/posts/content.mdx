...
`const home = {
    label: "Home",
    title: "Michael Plymire's Portfolio",
    description: "Portfolio website showcasing my work as a Software Engineer",
    headline: <>Software engineer and problem solver</>,
    subline: (
      <>
        ...
        <br /> and tackling challenging technical problems. After hours, I build my own projects.
      </>
    ),
};`,
    language: "tsx",
